...
class Artist : Serializable {
    ...
    fun withUri(uri: String?): Artist {
        this.uri = uri
        return this
    }

    fun withName(name: String?): Artist {
        this.name = name
        return this
    }
    ...
    fun withAdditionalProperty(name: String, value: Any): Artist {
        additionalProperties[name] = value
        return this
    }

    companion object {
        private const val serialVersionUID = 6961331703487904322L
    }
}